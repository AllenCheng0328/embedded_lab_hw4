...
const static char DEVICE_NAME[] = "Button_t0";
...
public:
    BatteryDemo(BLE &ble, events::EventQueue &event_queue) :
        ...
        _button(BUTTON1, BLE_BUTTON_PIN_PULL),

        _button_service(NULL),
        _button_uuid(ButtonService::BUTTON_SERVICE_UUID),

        _ID_service(NULL),
        _student_uuid(StudentID::STUDENT_UUID),
...
private:
    ...
    void on_init_complete(BLE::InitializationCompleteCallbackContext *params) {
        ...
        _ID_service = new StudentID(_ble, "b07901166");
    ...
    void on_data_written(const GattWriteCallbackParams *params) {
        ...
        if ((params->handle == _led_service->getValueHandle()) && (params->len == 1)) {
            ...
            else if (*(params->data) == 48) {
                _actuated_led = 0;
            }
            //_actuated_led = data-48;
            //printf("hi");
        }
    }
